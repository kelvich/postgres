...
extern PGDLLIMPORT session_guc double cursor_tuple_fraction;
 ...
 */
extern PGDLLIMPORT session_guc int from_collapse_limit;
extern PGDLLIMPORT session_guc int join_collapse_limit;

...
extern PGDLLIMPORT session_guc int xmlbinary;	/* XmlBinaryType, but int for guc enum */

extern PGDLLIMPORT session_guc int xmloption;	/* XmlOptionType, but int for guc enum */

...
/* ipc.c */
extern PGDLLIMPORT session_local bool proc_exit_inprogress;
extern PGDLLIMPORT session_local bool shmem_exit_inprogress;
...
/* ipci.c */
extern PGDLLIMPORT session_local shmem_startup_hook_type shmem_startup_hook;

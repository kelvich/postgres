...
extern PGDLLIMPORT session_local volatile sig_atomic_t ConfigReloadPending;
extern PGDLLIMPORT session_local volatile sig_atomic_t ShutdownRequestPending;

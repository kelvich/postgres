...
extern PGDLLIMPORT session_local volatile sig_atomic_t ParallelMessagePending;
extern PGDLLIMPORT session_local int ParallelWorkerNumber;
extern PGDLLIMPORT session_local bool InitializingParallelWorker;

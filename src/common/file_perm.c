...
session_local int			pg_dir_create_mode = PG_DIR_MODE_OWNER;
session_local int			pg_file_create_mode = PG_FILE_MODE_OWNER;
 ...
 */
session_local int			pg_mode_mask = PG_MODE_MASK_OWNER;

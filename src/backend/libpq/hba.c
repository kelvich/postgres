 ...
 */
static pg_global MemoryContext tokenize_context = NULL;

/*
 * pre-parsed content of HBA config file: list of HbaLine structs.
 * parsed_hba_context is the memory context where it lives.
 */
static pg_global List *parsed_hba_lines = NIL;
static pg_global MemoryContext parsed_hba_context = NULL;
 ...
 */
static pg_global List *parsed_ident_lines = NIL;
static pg_global MemoryContext parsed_ident_context = NULL;
